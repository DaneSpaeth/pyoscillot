...
par_stretching =  50 #'auto_0.5'     # stretch the x and y axes ratio ('auto' available)                            <--- PARAMETER 1
...
par_fwhm =  5 #'auto'               # FWHM of the CCF in km/s ('auto' available)                                   <--- PARAMETER 3
...
par_R = 3.0 #'auto'             # minimum radius of the rolling pin in angstrom ('auto' available)                  <--- PARAMETER 4
par_Rmax = 3.0 #'auto'          # maximum radius of the rolling pin in angstrom ('auto' available)                  <--- PARAMETER 5
...
count_out_lim = 30 #1       # number of outliers clipping in automatic mode (put at least 1 if Automatic mode)
