...
#par_stretching =  11.9 #'auto_0.5'     # stretch the x and y axes ratio ('auto' available)                            <--- PARAMETER 1
par_stretching = 12.0
...
par_fwhm =  4.71               # FWHM of the CCF in km/s ('auto' available)                                   <--- PARAMETER 3
...
# par_R = 11.2 #'auto'             # minimum radius of the rolling pin in angstrom ('auto' available)                  <--- PARAMETER 4
par_R = 550.0
# par_Rmax = 36.0 #'auto'          # maximum radius of the rolling pin in angstrom ('auto' available)                  <--- PARAMETER 5
par_Rmax=600.0
par_reg_nu = 'poly_1.1'    # penality-radius law                                                               <--- PARAMETER 6
...
count_cut_lim = 0       # number of border cut in automatic mode (put at least 3 if Automatic mode)
